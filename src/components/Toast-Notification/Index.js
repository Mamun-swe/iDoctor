...
import { ic_check_circle, ic_warning, ic_announcement, ic_error } from 'react-icons-kit/md';
        ...
        return (
            <div className={`notification-container ${position} ${toast}`}>
                <div className="d-flex">
                    <div>
                        {toast === 'success' ?
                            <Icon icon={ic_check_circle} size={25} style={{ color: '#fff' }} />
                            : toast === 'warning' ?
                                <Icon icon={ic_warning} size={25} style={{ color: '#fff' }} />
                                : toast === 'info' ?
                                    <Icon icon={ic_announcement} size={25} style={{ color: '#fff' }} />
                                    : toast === 'error' ?
