                        ...
                        <div className="card border-0 shadow-sm">
                            <div className="card-body p-4 p-lg-5">
                                ...
                                <div className="education-info pb-4">
                                    ...
                                    <hr className="my-1" />
                                    {doctor.college && doctor.passingYear && doctor.specialist && doctor.currentHospital ?
                                        <div>
                                ...
                                <div className="contact-info pb-4">
                                    ...
                                    {doctor.location ?
                                        <div>
                                            <p>Email: <span className="text-lowercase">{doctor.email}</span></p>
                                            <p>Country: {doctor.location ? doctor.location.address.country : null}</p>
                                            <p>City: {doctor.location ? doctor.location.address.city : null}</p>
                                            <p>Current address: {doctor.location ? doctor.location.address.currentAddress : null}</p>
                                        </div>
                                        : null}
                                </div>
                                        ...
                                        <tbody>
                                            {doctor.councilHour && doctor.councilHour.map((item, i) =>
                                                <tr key={i}>
                                                    ...
                                                    <td className="text-capitalize">{item.schedule.day}</td>
